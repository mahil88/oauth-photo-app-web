package com.appdevblog.ws.client.photoappweb.controller;

import com.appdevblog.ws.client.photoappweb.response.AlbumRest;
...
public class AlbumsController {
    ...
    public String getAlbumsWebClient(Model model,
